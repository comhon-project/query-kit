export default {
  ...
  go_to_query_builder: 'aller au constructeur de requête',
  undo: 'annuler',
  redo: 'rétablir',
  invalid_field: 'colonne invalide :',
  ...
  invalid_filter: 'filtre invalide, les résultats ne peuvent pas être affichés',
  entities: 'entités',
  reorder: 'réorganiser',
