export default {
  ...
  ilike: 'ধারণ করে (A=a)',
  not_ilike: 'ধারণ করে না (A=a)',
  ends_with: 'দিয়ে শেষ হয়',
  doesnt_end_with: 'দিয়ে শেষ হয় না',
  iends_with: 'দিয়ে শেষ হয় (A=a)',
  idoesnt_end_with: 'দিয়ে শেষ হয় না (A=a)',
  begins_with: 'দিয়ে শুরু হয়',
  doesnt_begin_with: 'দিয়ে শুরু হয় না',
  ibegins_with: 'দিয়ে শুরু হয় (A=a)',
  idoesnt_begin_with: 'দিয়ে শুরু হয় না (A=a)',
  in: 'মধ্যে',
  not_in: 'মধ্যে নেই',
  null: 'খালি',
  not_null: 'খালি নয়',
  ...
  item_moved: 'অবস্থানে সরানো হয়েছে',
  item_dropped: 'ছাড়া হয়েছে',
  reorder_cancelled: 'পুনর্বিন্যাস বাতিল করা হয়েছে',
};
