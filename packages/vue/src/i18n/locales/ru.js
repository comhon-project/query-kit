export default {
  ...
  undo: 'отменить',
  redo: 'повторить',
  invalid_field: 'недопустимый столбец:',
  ...
  invalid_filter: 'недопустимый фильтр, результаты не могут быть отображены',
  entities: 'сущности',
  reorder: 'переупорядочить',
  item_grabbed: 'захвачен, используйте стрелки для перемещения, Пробел чтобы отпустить',
  item_moved: 'перемещён на позицию',
  item_dropped: 'отпущен',
