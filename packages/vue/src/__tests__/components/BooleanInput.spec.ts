...
describe('BooleanInput', () => {
  it('renders two radio buttons', () => {
    const wrapper = mount(BooleanInput, { props: { ...ctx(), modelValue: true } });
  ...
  it('checks "no" radio when modelValue is false', () => {
    const wrapper = mount(BooleanInput, { props: { ...ctx(), modelValue: false } });
    const radios = wrapper.findAll('input[type="radio"]');
  ...
  it('emits update:modelValue true when "yes" radio is clicked', async () => {
    const wrapper = mount(BooleanInput, {
      props: { ...ctx(), modelValue: false, 'onUpdate:modelValue': () => {} },
    });
  ...
  it('emits update:modelValue false when "no" radio is clicked', async () => {
    const wrapper = mount(BooleanInput, {
      props: { ...ctx(), modelValue: true, 'onUpdate:modelValue': () => {} },
    });
  ...
  it('disables both radios when disabled', () => {
    const wrapper = mount(BooleanInput, { props: { ...ctx({ disabled: true }), modelValue: true } });
    const radios = wrapper.findAll('input[type="radio"]');
